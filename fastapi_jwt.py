...
async def create_user(user: UserSchema = Body(...)):
    """
    Description:
    Cette route permet à un utilisateur de s'inscrire en fournissant les détails de l'utilisateur. 
    Elle ajoute ensuite l'utilisateur à la liste des utilisateurs et renvoie un jeton JWT.
...
async def user_login(user: UserSchema = Body(...)):
    """
    Description:
    Cette route permet à un utilisateur de se connecter en fournissant les détails de connexion. 
    Si les détails sont valides, elle renvoie un jeton JWT. Sinon, elle renvoie une erreur.
