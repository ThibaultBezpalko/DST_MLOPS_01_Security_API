...
api.config["JWT_SECRET_KEY"] = "ff326d7fc45e4a68fcfd6004ba6f2202b9f93c91c325da73c4f22be0d98b21e7"  # Change this!
...
def login():
    ...
    Si l'authentification échoue en raison d'un mauvais nom d'utilisateur ou d'un mot de passe, une réponse JSON avec le statut 401 Unauthorized est renvoyée.
    """
...
def get_current_user():
    ...
    Raises:
    - Aucune exception n'est levée explicitement, sauf si la validation du jeton d'accès JWT échoue. 
...
def get_resource():
    ...
    return jsonify({"resource" : get_user(users_db, current_username)['resource'], "owner": current_username})
